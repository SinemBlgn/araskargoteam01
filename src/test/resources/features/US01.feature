...
Feature: US001
  ...
  @Tc03
  Scenario: Kariyer ddm menu secilir
    Given kullanici araskargo sayfasina gider
    When cikan pop-up'i kapatir
    And cerezleri kapatir
  ...
  @Tc04
  Scenario: Surdurulebilirlik ddm menu secilir
    Given kullanici araskargo sayfasina gider
    When cikan pop-up'i kapatir
    And cerezleri kapatir
  ...
  @Tc05
  Scenario: Is Ortagimiz Olun ddm menu secilir
    Given kullanici araskargo sayfasina gider
    When cikan pop-up'i kapatir
    And cerezleri kapatir
  ...
  @Tc06
  Scenario: Musteri iliskileri  ddm menu secilir
    Given kullanici araskargo sayfasina gider
    When cikan pop-up'i kapatir
    And cerezleri kapatir
  ...
  @Tc07
  Scenario:Aras Kargo Spor Kulubu ddm menu secilir
    Given kullanici araskargo sayfasina gider
    When cikan pop-up'i kapatir
    And cerezleri kapatir
  ...
  @Tc08
  Scenario: Bize Ulasin Olun ddm menu secilir
    Given kullanici araskargo sayfasina gider
    When cikan pop-up'i kapatir
    And cerezleri kapatir
